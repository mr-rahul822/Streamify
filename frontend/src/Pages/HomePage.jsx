...
const HomePage = () => {
    ...
    const queryClient = useQueryClient();
     ...
     const { data : recommendedUsers = [] , loadingUsers: loadingUsers } = useQuery({
       queryKey: ['users'],
          ...
          {loadingUsers ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {recommendedUsers.map((user) => {
                // Skip rendering if user is null or missing _id
                if (!user || !user._id) {
                  return null;
                }
                ...
                return (
                  ...
                  >
                    <div className="card-body p-5 space-y-4">
                      ...
                      {user.bio && <p className="text-sm opacity-70 text-ellipsis-2">{user.bio}</p>}
